...
public static class HttpOperationResultConverters {
    ...
    public static ProblemHttpResult ToHttpResult(this ReadOnlySpan<ErrorInfo> errors) {
        Guard.ThrowIfZero(errors.Length);
    ...
    static HttpContext HttpContext {
        get {
            if (httpContextAccessor == null)
                throw new InvalidOperationException($"{nameof(HttpOperationResultConverters)} was not properly configured");
