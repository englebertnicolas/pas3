...
public class CurrencyPairEntityConfiguration : IEntityTypeConfiguration<CurrencyPair> {
    ...
    public void Configure(EntityTypeBuilder<CurrencyPair> builder) {
        ...
        builder.OwnsMany(e => e.Rates, navsBuilder => {
            navsBuilder.ToTable("CurrencyRates");
